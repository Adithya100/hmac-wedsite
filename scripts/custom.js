...
function toggle_visibility(id) {
    ...
    if ($('.listing-items').hasClass('col-md-9')) {
        $('.listing-items').removeClass('col-md-9').addClass('col-md-12');
    } else if ($('.listing-items').hasClass('col-md-12')) {
        $('.listing-items').removeClass('col-md-12').addClass('col-md-9');
    }
   }
   $(function(){
  $("#img-pt").on({
   mouseenter: function(){
    $('.img-p').attr('src','./images/icon-w-p.png');
  },
  mouseleave: function(){
    $('.img-p').attr('src','./images/icon-b-p.png');
  }
  });
  $("#img-st").on({
    mouseenter: function(){
     $('.img-s').attr('src','./images/icon-w-s.png');
   },
   mouseleave: function(){
     $('.img-s').attr('src','./images/icon-b-s.png');
   }
   });
   $("#img-mk").on({
    mouseenter: function(){
     $('.img-m').attr('src','./images/icon-w-m2.png');
   },
   mouseleave: function(){
     $('.img-m').attr('src','./images/icon-b-m2.png');
   }
   });
   $("#img-dl").on({
    mouseenter: function(){
     $('.img-d').attr('src','./images/icon-w-d.png');
   },
   mouseleave: function(){
     $('.img-d').attr('src','./images/icon-b-d.png');
   }
   });
   $("#img-hms").on({
    mouseenter: function(){
     $('.img-hm').attr('src','./images/icon-w-hm.png');
   },
   mouseleave: function(){
     $('.img-hm').attr('src','./images/icon-b-hm.png');
   }
   });$("#img-bs").on({
    mouseenter: function(){
     $('.img-b').attr('src','./images/icon-w-bs.png');
   },
   mouseleave: function(){
     $('.img-b').attr('src','./images/icon-b-bs.png');
   }
   });
});
